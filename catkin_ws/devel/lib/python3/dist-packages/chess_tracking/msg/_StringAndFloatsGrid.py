...
"""autogenerated by genpy from chess_tracking/StringAndFloatsGrid.msg. Do not edit."""
import codecs
import sys
...
class StringAndFloatsGrid(genpy.Message):
  _md5sum = "61d312837c8724f6803b15d9751ac361"
  _type = "chess_tracking/StringAndFloatsGrid"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# StringAndFloatsGrid.msg
string[] name
float32[] x
float32[] y
float32[] z"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StringAndFloatsGrid, self).__init__(*args, **kwds)
